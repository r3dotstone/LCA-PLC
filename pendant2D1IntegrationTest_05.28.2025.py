    ...
    while error == 0:        
        ...
        while start == 1:
            ...
            while ref_done == 1:
                ...
                pDesired = 20*pins2Num(pPin0, pPin1, pPin2, pPin3)
                vDesired = 100*pins2Num(vPin0, vPin1, vPin2, vPin3)
                
                print("p num: ", pDesired)
                print("v num: ", vDesired)                
                
                
                #Aufruf der Bewegung B
                #Call Movement B
                abs(pDesired, vDesired)
